...
namespace PromptSearchTool
{
    ...
    public class ButtunPanel : Panel
    {
        #region 依存プロパティ
        ...
        public static readonly DependencyProperty RowsProperty = DependencyProperty.Register("Rows",
            typeof(int),
            typeof(ButtunPanel),
            new FrameworkPropertyMetadata(1, new PropertyChangedCallback(ButtunPanel.OnRowsChanged)));

        public static readonly DependencyProperty ColumnsProperty = DependencyProperty.Register("Columns",
            typeof(int),
            typeof(ButtunPanel),
            new FrameworkPropertyMetadata(1, new PropertyChangedCallback(ButtunPanel.OnColumnsChanged)));
        ...
        {
            ButtunPanel ctrl = d as ButtunPanel;
            if (ctrl != null)
            { }
        }
